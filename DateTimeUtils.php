...
/*
 * This file is part of the DateTimeUtils package.
 *
...
class DateTimeUtils extends DateTime
{
    ...
    public static function getInstance() {
        if (empty(self::$_instance)) {
            self::$_instance = new DateTimeUtils();
        }
    ...
    /**
     * A test DateTimeUtils instance to be returned when now instances are created
     *
     * @var DateTimeUtils
     */
    ...
    /**
     * Create a new DateTimeUtils instance.
     *
    ...
    /**
     * Create a DateTimeUtils instance from a DateTime one
     *
     * @param DateTime $dt
     *
     * @return static
     ...
     * DateTimeUtils::parse('Monday next week')->fn() rather than
     * (new DateTimeUtils('Monday next week'))->fn()
     *
     * @param string              $time
     * @param DateTimeZone|string $tz
     *
    ...
    /**
     * Get a DateTimeUtils instance for the current date and time
     *
     * @param DateTimeZone|string $tz
     *
     * @return static
    ...
    /**
     * Create a DateTimeUtils instance for today
     *
     * @param DateTimeZone|string $tz
     *
     * @return static
    ...
    /**
     * Create a DateTimeUtils instance for tomorrow
     *
     * @param DateTimeZone|string $tz
     *
     * @return static
    ...
    /**
     * Create a DateTimeUtils instance for yesterday
     *
     * @param DateTimeZone|string $tz
     *
     * @return static
    ...
    /**
     * Create a DateTimeUtils instance for the greatest supported date.
     *
     * @return DateTimeUtils
     */
    ...
    /**
     * Create a DateTimeUtils instance for the lowest supported date.
     *
     * @return DateTimeUtils
     */
    ...
    /**
     * Create a new DateTimeUtils instance from a specific date and time.
     *
    ...
    /**
     * Create a DateTimeUtils instance from just a date. The time portion is set to now.
     *
     * @param integer             $year
     * @param integer             $month
     * @param integer             $day
    ...
    /**
     * Create a DateTimeUtils instance from just a time. The date portion is set to today.
     *
     * @param integer             $hour
     * @param integer             $minute
     * @param integer             $second
    ...
    /**
     * Create a DateTimeUtils instance from a specific format
     *
     * @param string              $format
     * @param string              $time
     * @param DateTimeZone|string $tz
    ...
    /**
     * Create a DateTimeUtils instance from a timestamp
     *
    ...
    /**
     * Create a DateTimeUtils instance from an UTC timestamp
     *
     * @param integer $timestamp
     *
     * @return static
    ...
    /**
     * Get a part of the DateTimeUtils object
     *
     * @param string $name
     *
     * @throws InvalidArgumentException
    ...
    /**
     * Set a part of the DateTimeUtils object
     *
     * @param string                      $name
    ...
    /**
     * Set a DateTimeUtils instance (real or mock) to be returned when a "now"
     * instance is created.  The provided instance will be returned
     * specifically under the following conditions:
     *   - A call to the static now() method, ex. DateTimeUtils::now()
     *   - When a null (or blank string) is passed to the constructor or parse(), ex. new DateTimeUtils(null)
     *   - When the string "now" is passed to the constructor or parse(), ex. new DateTimeUtils('now')
     *
     ...
     * parameter of null.
     *
     * @param DateTimeUtils $testNow
     */
    public static function setTestNow(DateTimeUtils $testNow = null)
    {
        static::$testNow = $testNow;
    }

    /**
     * Get the DateTimeUtils instance (real or mock) to be returned when a "now"
     * instance is created.
     *
    ...
    /**
     * Reset the format used to the default when type juggling a DateTimeUtils instance to a string
     *
     */
    ...
    /**
     * Set the default format used when type juggling a DateTimeUtils instance to a string
     *
     * @param string $format
     */
     ...
     *
     * @param DateTimeUtils $dt
     *
     * @return boolean
     */
    public function eq(DateTimeUtils $dt)
    {
        return $this == $dt;
    }
     ...
     * @return boolean
     */
    public function ne(DateTimeUtils $dt)
    {
        return !$this->eq($dt);
    }
     ...
     * @return boolean
     */
    public function gt(DateTimeUtils $dt)
    {
        return $this > $dt;
    }
     ...
     * @return boolean
     */
    public function gte(DateTimeUtils $dt)
    {
        return $this >= $dt;
    }
     ...
     * @return boolean
     */
    public function lt(DateTimeUtils $dt)
    {
        return $this < $dt;
    }
     ...
     * @return boolean
     */
    public function lte(DateTimeUtils $dt)
    {
        return $this <= $dt;
    }
   ...
   *
   * @param  DateTimeUtils  $dt1
   * @param  DateTimeUtils  $dt2
   * @param  boolean $equal  Indicates if a > and < comparison should be used or <= or >=
   *
   * @return boolean
   */
    public function between(DateTimeUtils $dt1, DateTimeUtils $dt2, $equal = true)
    {
        if ($dt1->gt($dt2)) {
            $temp = $dt1;
            $dt1 = $dt2;
     ...
     * @return static
     */
    public function min(DateTimeUtils $dt = null)
    {
     ...
     * @return static
     */
    public function max(DateTimeUtils $dt = null)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
     ...
     * @return boolean
     */
    public function isSameDay(DateTimeUtils $dt)
    {
     ...
     * @return integer
     */
    public function diffInYears(DateTimeUtils $dt = null, $abs = true)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
     ...
     * @return integer
     */
    public function diffInMonths(DateTimeUtils $dt = null, $abs = true)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
     ...
     * @return integer
     */
    public function diffInWeeks(DateTimeUtils $dt = null, $abs = true)
    {
     ...
     * @return integer
     */
    public function diffInDays(DateTimeUtils $dt = null, $abs = true)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
      ...
      * @return int
      */
     public function diffInDaysFiltered(Closure $callback, DateTimeUtils $dt = null, $abs = true)
     {
          $start = $this;
          ...
          $days = array_filter(iterator_to_array($period), function (DateTime $date) use ($callback) {
                return call_user_func($callback, DateTimeUtils::instance($date));
          });
      ...
      * @return int
      */
     public function diffInWeekdays(DateTimeUtils $dt = null, $abs = true)
     {
          return $this->diffInDaysFiltered(function (DateTimeUtils $date) {
      ...
      * @return int
      */
     public function diffInWeekendDays(DateTimeUtils $dt = null, $abs = true)
     {
          return $this->diffInDaysFiltered(function (DateTimeUtils $date) {
     ...
     * @return integer
     */
    public function diffInHours(DateTimeUtils $dt = null, $abs = true)
    {
     ...
     * @return integer
     */
    public function diffInMinutes(DateTimeUtils $dt = null, $abs = true)
    {
     ...
     * @return integer
     */
    public function diffInSeconds(DateTimeUtils $dt = null, $abs = true)
    {
     ...
     * 5 months after
     *
     * @param DateTimeUtils $other
     * @param bool   $absolute removes time difference modifiers ago, after, etc
     *
     * @return string
     */
    public function diffForHumans(DateTimeUtils $other = null, $absolute = false)
    {
        $isNow = $other === null;
     ...
     * @return static
     */
    public function average(DateTimeUtils $dt = null)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
     ...
     * @return boolean
     */
    public function isBirthday(DateTimeUtils $dt)
    {
